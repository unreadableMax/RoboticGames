...
for i in range(1, 6):
    ...
    background = plt.imread("worlds/2D-Model/rgarena"+str(map_nr)+".png")
    plt.imshow(background, extent=[-3.14+spawn_point[map_nr-1, 0], 3.14 +
                                   spawn_point[map_nr-1, 0], -3.14+spawn_point[map_nr-1, 1], 3.14+spawn_point[2-1, 1]])
