...
for i in range(1,6):
    ...
    background=plt.imread("worlds/2D-Model/rgarena"+str(i)+".png")
    plt.imshow(background,extent=[-3.14+spawn_point[i-1,0],3.14+spawn_point[i-1,0],-3.14+spawn_point[i-1,1],3.14+spawn_point[i-1,1]])
